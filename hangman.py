...
kitchen = ["knife", "spoon", "grater", "peeler", "plate", "glass", "bowl", "pot", "pan", "fork", "mug", "stove", "oven", "grill", "chef", "cook", "steam", "bake", "boil", "mixer", "blender", "toaster", "chop", "whisk", "ladle", "grate", "cut", "slice", "pour", "simmer", "saute", "roast", "broil", "measure", "taste", "sieve", "drain", "spice", "kettle", "timer", "apron", "utensil", "napkin", "table", "kitchen", "ingredient", "recipe", "food", "meal"]

school = ["book", "pencil", "desk", "chalk", "class", "study", "learn", "math", "science", "history", "art", "music", "teacher", "student", "board", "note", "paper", "write", "read", "quiz", "exam", "grade", "project", "lecture", "lesson", "college", "university", "lab", "textbook", "assignment", "homework", "research", "test", "calculator", "marker", "eraser", "backpack", "diagram", "education", "knowledge", "scholar", "question", "answer", "notebook", "highlight", "classroom"]

sports = ["ball", "golf", "tennis", "hockey", "soccer", "cricket", "rugby", "swim", "run", "jump", "throw", "catch", "goal", "team", "coach", "player", "match", "court", "field", "gym", "stadium", "race", "bat", "glove", "club", "rink", "net", "racket", "driver", "par", "birdie", "eagle", "putt", "serve", "ace", "strike", "dive", "kick", "pass", "block", "tackle", "sprint", "dribble", "shoot", "score", "win", "lose"]

camping = ["tent", "fire", "rope", "map", "hike", "camp", "sleep", "outdoor", "nature", "backpack", "trail", "cook", "forest", "mountain", "lake", "river", "campfire", "flashlight", "compass", "binoculars", "adventure", "wild", "wildlife", "explore", "campsite", "stove", "lantern", "sleeping", "bag", "hiking", "trek", "adventure", "exploration", "firewood", "outdoor", "wilderness", "marshmallow", "tent", "hammock", "campground", "nature", "cooler", "smores", "picnic", "hiker", "trailblazer"]

literature = ["novel", "poetry", "drama", "prose", "essay", "fiction", "story", "book", "author", "poet", "play", "verse", "plot", "character", "theme", "genre", "literary", "language", "symbol", "narrative", "metaphor", "rhyme", "stanza", "imagery", "dialogue", "monologue", "soliloquy", "prologue", "epilogue", "chapter", "novella", "classic", "tragedy", "comedy", "satire", "fantasy", "mystery", "adventure", "science", "biography", "autobiography", "critic", "library", "reader", "text"]

music = ["song", "guitar", "drums", "piano", "violin", "flute", "trumpet", "saxophone", "singer", "musician", "band", "album", "melody", "harmony", "rhythm", "beat", "note", "chord", "lyrics", "solo", "duet", "concert", "symphony", "opera", "acoustic", "electric", "genre", "classical", "rock", "pop", "jazz", "blues", "country", "hiphop", "rap", "reggae", "folk", "indie", "ballad", "instrument", "studio", "producer", "audience", "stage", "performance", "tour", "radio", "stream"]

flowers = ["rose", "tulip", "daisy", "lily", "iris", "orchid", "sunflower", "daffodil", "carnation", "poppy", "dandelion", "lavender", "jasmine", "peony", "marigold", "violet", "chrysanthemum", "hibiscus", "lotus", "dahlia", "hydrangea", "cactus", "aster", "bluebell", "buttercup", "crocus", "daisy", "geranium", "gerbera", "honeysuckle", "magnolia", "morning", "glory", "narcissus", "pansy", "petunia", "primrose", "snapdragon", "sunflower", "tulip", "zinnia", "blossom", "botany", "floral", "garden"]
#DEFINGING GET WORD
